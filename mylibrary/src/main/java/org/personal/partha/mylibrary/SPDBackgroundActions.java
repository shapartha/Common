...
public class SPDBackgroundActions extends AsyncTask<Object, Void, Object> {
    ...
    protected Object doInBackground(Object... params) {
        ...
        objectClass = (String) params[1];
        if (objectClass.toUpperCase().equals("INITIALIZE_API")) {
            return SPDUtilities.initRESTAPI((String) params[2], (String) params[3], (SPDUtilities.RestApiCallback) params[4]);
        } else if (objectClass.toUpperCase().equals("INVOKE_APP_REST_API")) {
            String functionName = (String) params[2];
//            AppUtil.AppModel appModelObject = (AppUtil.AppModel) params[3];
//            return AppUtil.restApiOps(functionName, appModelObject);
        }
        return null;
    }
}
